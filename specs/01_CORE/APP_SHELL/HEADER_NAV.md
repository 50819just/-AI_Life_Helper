...
定義 AI Life Assistant 的 Header、Top Nav、Left Sidebar / App Shell 規則。
...
Dashboard 可以是 Home 的 summary section 或次級 overview，不是 MVP 主導航。
