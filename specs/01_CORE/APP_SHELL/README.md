...
集中管理 AI Life Assistant 的全域產品框架規則，包含 Header、Navigation、Mobile Bottom Navigation 與 Footer。
...
- Home、Devices、Tasks、Settings 都應共用一致的 app shell 規則。
...
- Dashboard 不放 mobile bottom navigation；Dashboard Summary 是 Home 裡的摘要區塊。
