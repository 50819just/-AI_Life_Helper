...
## 文件用途
定義 AI Life Assistant / AI 生活小幫手的產品方向、使用情境、設計原則與初版範圍，作為後續 UX、UI 與開發規格的共同基準。

## 初版規格
- 產品類型：生活型 AI 助理與智慧家庭控制產品。
- 核心能力：AI 對話、今日摘要、提醒管理、行程輔助、智慧燈光與家電快速控制。
- 設計語氣：Apple Home inspired、日常、安定、低干擾、不過度科幻。
- 支援模式：Light Mode / Dark Mode / 夜間低亮度操作。
...
## Responsive 規則
- Desktop 以資訊總覽與多欄卡片為主。
- Tablet 以雙欄或重點卡片堆疊為主。
- Mobile 以 Bottom Navigation 串接核心任務，單欄呈現。

## Stitch MCP 可理解描述
建立一個 calm smart home AI dashboard，首頁聚合 AI greeting、today summary、smart home quick controls、reminder preview，整體視覺柔和、清楚、像 Apple Home 但不要直接複製。
