# NestBuddy-AiLife / NestBuddy / 巢伴

## 專案定位
NestBuddy 是一個結合 AI 助理、智慧家電控制、AI 提醒與行程管理的生活型產品。整體設計方向參考 Apple Home 的日常智慧家庭感，採用高可讀性、Soft Glassmorphism、Light / Dark Mode 與 Calm Technology 原則。
...
- 目前以 **現行畫面** 為準：Home 與 Dashboard 已合併為同一個首頁入口，不再拆成兩套主流程。
- 目前優先以 Light Mode 作為主畫面基準；Dark Mode 先保留既有系統，不在這一輪重做。
- Light Mode 採用 softened Atmospheric Glassmorphism：warm white、pale mint、soft teal、soft blue、lavender / blue shadow，搭配目前已上線的藍色漸層 CTA 與白字白 icon。
